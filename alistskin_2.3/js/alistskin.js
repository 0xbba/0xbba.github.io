...
$("html").click(function() {
    if (x) {
        var title = document.title,
            ...
            linkname = ["首页", "OMV", "Qbt", "Por", "Jel", "Ari", "Lyq"],
            link = ["/", "http://192.168.123.220/", "http://192.168.123.220:9091", "http://192.168.123.220:9000", "http://192.168.123.220:8096", "http://192.168.123.220:6880", "http://192.168.123.1"],
            code = "";
